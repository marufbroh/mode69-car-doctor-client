...
const BookingsRow = ({ booking, handleDelete, bookingBookingConfirm }) => {
    // console.log(booking);
            ...
            <th>
                {
                    ...
                    <button onClick={() => bookingBookingConfirm(_id)} className="btn btn-ghost btn-xs">Please Confirm</button>
                }
            </th>
        </tr>
    );
